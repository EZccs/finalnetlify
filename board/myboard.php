...
<html>
    ...
    <body>
        ...
        <table class="table">
            <tr><td colspan="2"><h2>내가 쓴 게시글</h2></td></tr>
            <tr class="header">
                <td class="num">번호</td>
            ...
            <?php
               if(isset($_GET['page'])) {
                ...
                $sql = myquery("select * from boardtable where logcheck=1 and name='".$_SESSION['name']."'");
                ...
                $sql2 = myquery("select * from boardtable where logcheck=1 and name='".$_SESSION['name']."' order by id desc limit $start_num, $list");
            ...
            <tr>
                ...
                <td><a href="/board/myview.php?id=<?php echo $board["id"];?>"><?php echo $title; ?><span class="re_ct">
                    <?php if ($rep_count > 0) {
